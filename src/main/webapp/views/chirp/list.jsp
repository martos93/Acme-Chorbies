...
<b><spring:message code="chirp.received"/></b><br>
<display:table name="received" id="row" requestURI="${requestUri}"
	...
	<input type="button" onclick="document.location.href='chirp/chorbi/reply.do?senderName=${row.sender.name}'" value="${replyColumn }"/>
	</display:column>	
		
</display:table>

<br><br>
<b><spring:message code="chirp.sended"/></b><br>
<display:table name="sended" id="row" requestURI="${requestUri}"
	...
	<input type="button" onclick="document.location.href='chirp/chorbi/forward.do?chirpId=${row.id}'" value="${forwardColumn }"/>
	</display:column>
